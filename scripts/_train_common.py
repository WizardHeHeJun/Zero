...
class PlateauStopper:
    ...
    **为什么不放宽到 1e-3**：那样生理通道会停在 1400 步，而它的 15 折 LOSO 证据显示 val 一直
    降到 3000（argmin 众数 3000），1400 属欠收敛；反过来 FACS / 韵律跑满 5000 落在
    「1000 vs 2000 vs 5000 配对检验全不显著」的区间内，只是慢一点、不损失质量。宁可多跑。
    """
